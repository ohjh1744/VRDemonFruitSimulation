...
public class Haki : MonoBehaviour
{
    ...
    [SerializeField] private float _lightIntensity; //light이펙트 세기

    [SerializeField] private float _vibration; // 진동세기

    [SerializeField] private float _maxVibration; // 진동세기

    [SerializeField] private float _vibrateDurateTime; //진동시간
